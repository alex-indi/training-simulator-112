...
**Статус:** целевая архитектура. Новые модели данных и API входят в отдельные задачи.
